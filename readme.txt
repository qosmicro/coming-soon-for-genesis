...
2. Search for 'Genesis Coming Soon'
3. Click 'Install Now'
...
= Can I create maintenance mode page with this plugin ? =

Yes, the plugin also supports maintenance mode feature.

= Can I access my website when coming soon mode is activated ? =

Yes, logged in users will see your website.

= Can I any page in my website as a 'Coming Soon' page ? =
